    ...
    expected_json = {
        "grammar": {
            ...
            "complete_fsm": {
                "edges": {
                    "data_": [
                        [0, 47, 4], [58, 127, 4], [192, 223, 3], [224, 239, 5],
                        [240, 243, 6], [244, 244, 1], [128, 143, 5], [128, 191, 4],
                        [-2, 0, 2], [128, 191, 3], [128, 191, 5], [-2, 0, 9], [97, 97, 7],
                    ],
                    "indptr_": [0, 6, 7, 7, 8, 9, 10, 11, 11, 12, 13],
                },
                "edge_aux_data": [],
            },
            "per_rule_fsms": [
                [
                    {
                        "edges": {
                            "data_": [
                                [0, 47, 4], [58, 127, 4], [192, 223, 3], [224, 239, 5],
                                [240, 243, 6], [244, 244, 1], [128, 143, 5], [128, 191, 4],
                                [-2, 0, 2], [128, 191, 3], [128, 191, 5], [-2, 0, 9],
                                [97, 97, 7],
                            ],
                            "indptr_": [0, 6, 7, 7, 8, 9, 10, 11, 11, 12, 13],
                        },
